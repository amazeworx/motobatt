 ...
 *
 */
function gfs_post_summary_title() {
	global $wp_query;
 ...
 *
 */
function gfs_post_summary_image( $size = 'thumbnail_medium' ) {
	echo '<a class="post-summary__image" href="' . get_permalink() . '" tabindex="-1" aria-hidden="true">' . wp_get_attachment_image( gfs_entry_image_id(), $size ) . '</a>';
}
 ...
 *
 */
function gfs_entry_image_id() {
	return has_post_thumbnail() ? get_post_thumbnail_id() : get_option( 'options_gfs_default_image' );
}
