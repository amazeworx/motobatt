...
function single_product_actions()
{
  if (is_singular('motobatt_products')) {
    ...
    add_action('genesis_entry_header', 'button_onlineshop');
...
function button_onlineshop()
{
  echo '<h4 class="section-heading">' . __('Produk ini tersedia di', 'motobatt') . '</h4>';
  echo '<div class="buttons-olshop">';
  echo '<a href="https://shopee.co.id/motobattofficial" class="olshop-link" target="_blank"><img src="' . get_stylesheet_directory_uri() . '/assets/images/icon-shopee.png' . '" alt="shopee" /></a>';
  echo '<a href="https://www.tokopedia.com/motobattofficialshop" class="olshop-link" target="_blank"><img src="' . get_stylesheet_directory_uri() . '/assets/images/icon-tokopedia.png' . '" alt="shopee" /></a>';
  echo '<a href="https://www.lazada.co.id/shop/motobatt-official-shop" class="olshop-link" target="_blank"><img src="' . get_stylesheet_directory_uri() . '/assets/images/icon-lazada.png' . '" alt="shopee" /></a>';
  echo '<a href="https://www.bukalapak.com/motobatt-indonesia-official" class="olshop-link" target="_blank"><img src="' . get_stylesheet_directory_uri() . '/assets/images/icon-bukalapak.png' . '" alt="shopee" /></a>';
  echo '</div>';
}
